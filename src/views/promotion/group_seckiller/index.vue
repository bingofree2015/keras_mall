...
<template>
    <div class="page-container">
                    ...
                    <el-form-item>
                        <el-input placeholder="请输入内容" v-model="filters.value">
                            ...
                            <ext-button :label="$t('action.search')" @click="queryForPaginatedList()"
                                icon="el-icon-ali-chazhaobiaodanliebiao" perms="promotion:group_seckiller:view"
                                slot="append" type="primary" />
                        </el-input>
                    </el-form-item>
                    <el-form-item>
                        <ext-button :label="$t('action.add')" @click="handleAdd" icon="el-icon-ali-add"
                            perms="promotion:group_seckiller:add" type="primary" />
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
        ...
        <ext-table :batchDelete="batchDelete" :columns="columns" :count="paginated.attrs.count" :data="paginated.list"
            ...
            :permsBatchDelete="permsBatchDelete" @queryForPaginatedList="queryForPaginatedList" aliasName="promotion">
        </ext-table>
    </div>
</template>
...
export default {
    ...
    data () {
        return {
            ...
            paginated: {
                attrs: { searchKey: { type: [3, 4] }, currPage: 1, offset: 0, limit: 9, count: 0 },
                list: []
            },
            columns: [
            ...
            operations: [
                {
                    ...
                    // type: 'primary',            // 按钮类型
                    func: (row) => {
                        this.$router.push({ path: '/promotion/group_seckiller/edit', query: { id: row.id, isCreating: false } })
                    }
                }, {
                    label: 'action.delete',
            ...
            permsBatchDelete: 'promotion:group_seckiller:delete'
        }
    },
    methods: {
        // 获取分页数据
        async queryForPaginatedList (data) {
            ...
            this.paginated.attrs.searchKey = { type: [3, 4] }
        ...
        // 显示新增界面
        handleAdd () {
            this.$router.push({ path: '/promotion/group_seckiller/edit', query: { id: 0, isCreating: true } })
        }
    },
    mounted () { }
}
