            ...
            <el-col :span="16">
                ...
                <el-form :model="formData" :rules="formDataRules" :size="normalSize" label-width="100px" ref="formData">
                    ...
                    <el-form-item label="促销名称" prop="name">
                        ...
                        <span class="tip-info">
                            <i class="el-icon-ali-tishi"></i> 促销名称会显示到前台，请合理输入此名称
                        </span>
                    </el-form-item>
                    <el-row>
                        <el-col :span="8">
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="是否排他" prop="exclusive">
                                <el-switch active-text="是" inactive-text="否" v-model="formData.exclusive"></el-switch>
                            </el-form-item>
                        </el-col>
                        <el-col :span="16">
    ...
    data () {
        return {
            ...
            formData: {
                ...
                type: 1, // 类型 1:促销 2:优惠券 3:团购 4:秒杀
                sort: 0, // 排序
                params: null, // 其它参数
