                    ...
                    <el-form-item>
                        <el-input placeholder="请输入内容" v-model="filters.value">
                            ...
                            <ext-button :label="$t('action.search')" @click="queryForPaginatedList()"
                                icon="el-icon-ali-chazhaobiaodanliebiao" perms="marketing:notice:view" slot="append"
                                type="primary" />
                        </el-input>
                    </el-form-item>
                    <el-form-item>
                        <ext-button :label="$t('action.add')" @click="handleAdd" icon="el-icon-ali-add"
                            perms="marketing:notice:add" type="primary" />
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
                ...
                <el-row>
                    <el-col :span="16">
                        ...
                        <el-form-item label="内容" prop="content">
                            <el-input :autosize="{ minRows: 4, maxRows: 8}" maxlength="1024" placeholder="请输入内容"
                                show-word-limit type="textarea" v-model="formData.content"></el-input>
                        </el-form-item>
    ...
    data () {
        return {
            ...
            columns: [
                ...
                { prop: 'content', label: '公告内容', minWidth: 240, showOverflowTooltip: true },
            ...
            this.$refs.formData.validate(valid => {
                if (valid) {
                    this.$confirm('确认提交吗？', '提示', {}).then(async () => {
                        ...
                        if (_result.succeed === 1 && _result.code === 200) {
                            const _notice = this.paginated.list.find(v => v.id === _result.data.id)
                            if (!_notice) {
