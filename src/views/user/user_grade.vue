                    ...
                    <el-form-item>
                        <el-input placeholder="请输入内容" v-model="filters.value">
                            ...
                            <ext-button :label="$t('action.search')" @click="queryForPaginatedList()"
                                icon="el-icon-ali-chazhaobiaodanliebiao" perms="user:user_grade:view" slot="append"
                                type="primary" />
                        </el-input>
                    </el-form-item>
                    <el-form-item>
                        <ext-button :label="$t('action.add')" @click="handleAdd" icon="el-icon-ali-add"
                            perms="user:user_grade:add" type="primary" />
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
                ...
                <el-row>
                    <el-col :span="16">
                        <el-form-item label="编号" prop="level">
                            <el-input-number :min="0" controls-position="right" label="编号" style="width:100px"
                                v-model="formData.level"></el-input-number>
                        </el-form-item>
...
export default {
    ...
    data () {
        return {
            ...
            columns: [
                ...
                { prop: 'isDef', label: '默认', minWidth: 80, formatter: this.columnFormatter },
    ...
    methods: {
        // 列内容格式化
        columnFormatter (value, row, column) {
            return this.mapAlias.user_grade[column][value]
        },
        // 获取分页数据
